...
+(void) showMessage: (NSString *) title message: (NSString*) msg Actions:(NSString*) actions {
    ...
    if (tokensCount == 1) {
        ...
        UIAlertAction* defaultAction = [UIAlertAction actionWithTitle:positiveAction style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
            ...
            [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"%@%@%@", @"IOSPopUp ", positiveAction, @" action"];
            UnitySendMessage("IOSPopUp", "onPopUpCallBack", [ISN_DataConvertor NSStringToChar:positiveAction]);
            _currentAlert = nil;
        ...
        UIAlertAction* noAction = [UIAlertAction actionWithTitle:negativeAction style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
            ...
            [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"%@%@%@", @"IOSPopUp ", negativeAction, @" action"];
            UnitySendMessage("IOSPopUp", "onPopUpCallBack", [ISN_DataConvertor NSStringToChar:negativeAction]);
            _currentAlert = nil;
        ...
        UIAlertAction* rateAction = [UIAlertAction actionWithTitle:neutralAction style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
            ...
            [[ISN_NativeUtility sharedInstance] ISN_NativeLog: @"%@%@%@", @"IOSPopUp ", neutralAction, @" action"];
            UnitySendMessage("IOSPopUp", "onPopUpCallBack", [ISN_DataConvertor NSStringToChar:neutralAction]);
            _currentAlert = nil;
    ...
    /*if([ISN_NativeUtility majorIOSVersion] <8 ) {
        #if !TARGET_OS_TV
            [ISN_NativePopUpsManager showMessage_old:[ISN_DataConvertor charToNSString:title] message:[ISN_DataConvertor charToNSString:message] okTitle:[ISN_DataConvertor charToNSString:actions]];
        #endif
    }
...
extern "C" {
    ...
    void _MNP_ShowMessage(char* title, char* message, char* actions) {
        [ISN_NativePopUpsManager showMessage:[ISN_DataConvertor charToNSString:title] message:[ISN_DataConvertor charToNSString:message] Actions:[ISN_DataConvertor charToNSString:actions]];
    }
