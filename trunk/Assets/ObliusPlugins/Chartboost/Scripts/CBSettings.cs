...
namespace ChartboostSDK {
	...
	public class CBSettings : ScriptableObject
	{
	    ...
	    const string cbSettingsPath = "ObliusPlugins/Chartboost/Resources";
	...
	#if UNITY_EDITOR
	    [MenuItem("ObliusPlugins/Chartboost/Edit Settings")]
	    public static void Edit()
	    {
	        Selection.activeObject = Instance;
	    }

	    [MenuItem("ObliusPlugins/Chartboost/SDK Documentation")]
